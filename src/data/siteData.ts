    ...
    children: [
      {
        ...
        children: [
          { label: "Farm Business Planning", href: "/services/farm-planning/farm-business-planning", image: "/assets/service/service image new/Farm Business Planning.webp", alt: "Top Agri consulting brand in India" },
          { label: "Agri Investment Consulting", href: "/services/farm-planning/agri-investment-consulting", image: "/assets/service/service image new/Agri Investment Consulting.webp", alt: "Best Agri Business Plan Consultant in India" },
          { label: "Crop Selection Consulting", href: "/services/farm-planning/crop-selection-consulting", image: "/assets/service/service image new/Crop Selection Consulting.webp", alt: "Drip irrigation installation and Cold Storage Construction" },
          { label: "Farm Layout Design", href: "/services/farm-planning/farm-layout-design", image: "/assets/service/service image new/Farm Layout Design.webp", alt: "How to do farm layout design?" },
          { label: "Aquaculture Consulting", href: "/services/farm-planning/aquaculture-consulting", image: "/assets/service/service image new/Aquaculture Consulting.webp", alt: "What kind of Aquaculture project is suitable for india?" },
          { label: "Land Surveying", href: "/services/farm-planning/land-surveying", image: "/assets/service/service image new/Land Surveying.webp", alt: "Top Land Surveying Company near me" },
        ]
      },
      {
        ...
        children: [
          { label: "Polyhouse Installation", href: "/services/farming-project-setup/polyhouse-installation", image: "/assets/service/service image new/Polyhouse Installation.webp", alt: "best polyhouse installation service in india" },
          { label: "Hydroponic Setup", href: "/services/farming-project-setup/hydroponic-setup", image: "/assets/service/service image new/Hydroponic Setup.webp", alt: "hydrophonic setup cost in Tamil Nadu" },
          { label: "Vertical Farming Setup", href: "/services/farming-project-setup/vertical-farming-setup", image: "/assets/service/service image new/Vertical Farming Setup.webp", alt: "Cost of vertical farming setup in Bangalore " },
          { label: "Fish Farming Setup", href: "/services/farming-project-setup/fish-farming-setup", image: "/assets/service/service image new/Fish Farming Setup.webp", alt: "Fish Farming Setup Cost in India" },
          { label: "Biofloc Installation", href: "/services/farming-project-setup/biofloc-installation", image: "/assets/service/service image new/Biofloc Installation.webp", alt: "Biofloc Setup Cost in India" },
          { label: "Aquaculture Pond Construction", href: "/services/farming-project-setup/aquaculture-pond-construction", image: "/assets/service/service image new/Pond Construction.webp", alt: "Aquaculture Pond Construction Cost in India" },
          { label: "Aquaponics Setup", href: "/services/farming-project-setup/aquaponics-setup", image: "/assets/service/service image new/Aquaponics Setup.webp", alt: "Aquaponics Setup Cost in India" },
          { label: "Goat Farm Setup", href: "/services/farming-project-setup/goat-farm-setup", image: "/assets/service/service image new/Goat Farm Setup.webp", alt: "Goat Farm Setup Cost in India" },
          { label: "Dairy Farm Setup", href: "/services/farming-project-setup/dairy-farm-setup", image: "/assets/service/service image new/Dairy Farm Setup.webp", alt: "Dairy Farm Setup Cost in India" },
          { label: "Sheep Farm Setup", href: "/services/farming-project-setup/sheep-farm-setup", image: "/assets/service/service image new/Sheep Farm Setup.webp", alt: "Sheep Farm Setup Cost in India" },
      ...
      },
      {
        ...
        children: [
          { label: "Cold Storage Construction", href: "/services/farm-infrastructure/cold-storage-construction", image: "/assets/service/service image new/Cold Storage Construction.webp", alt: "Cold Storage Construction Cost in India" },
          { label: "Packhouse Construction", href: "/services/farm-infrastructure/packhouse-construction", image: "/assets/service/service image new/Packhouse Construction.webp", alt: "Estimation of pachouse construction in india" },
          { label: "Farm Building Design", href: "/services/farm-infrastructure/farm-building-design", image: "/assets/service/service image new/Farm Building Design.webp", alt: "Best farm Building Design in Tamilnadu" },
          { label: "Drip Irrigation Installation", href: "/services/farm-infrastructure/drip-irrigation-installation", image: "/assets/service/service image new/Drip Irrigation Installation.webp", alt: "Drip irrigation installation Cost?" },
          { label: "Sprinkler Irrigation Systems", href: "/services/farm-infrastructure/sprinkler-irrigation-systems", image: "/assets/service/service image new/Sprinkler Systems.webp", alt: "Schemes for sprinkler Irrigation system" },
          { label: "Water Pump Systems", href: "/services/farm-infrastructure/water-pump-systems", image: "/assets/service/service image new/Water Pump Systems.webp", alt: "How to choose water pump for irrigation?" },
          { label: "Land Leveling", href: "/services/farm-infrastructure/land-leveling", image: "/assets/service/service image new/Land Leveling.webp", alt: "Laser Land Leveling machine subsidy" },
        ]
      },
      {
        ...
        children: [
          { label: "Livestock Shed Construction", href: "/services/maintenance-support/livestock-shed-construction", image: "/assets/service/service image new/Livestock Shed Construction.webp", alt: "Complete solution to set up Goat Farm" },
          { label: "Polyhouse AMC", href: "/services/maintenance-support/polyhouse-amc", image: "/assets/service/service image new/Polyhouse AMC.webp", alt: "Best Polyhouse maintenance and servicing in Tamilnadu" },
          { label: "Hydroponic System AMC", href: "/services/maintenance-support/hydroponic-system-amc", image: "/assets/service/service image new/Hydroponic AMC.webp", alt: "Cost of hydrophonic AMC?" },
          { label: "Farm Equipment Maintenance", href: "/services/maintenance-support/farm-equipment-maintenance", image: "/assets/service/service image new/Equipment Maintenance.webp", alt: "Farm equipment service center in Namakkal" },
        ]
      }
    ],
  },
